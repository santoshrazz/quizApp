...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-[#8e8cec] w-full flex items-center justify-center gap-5 flex-col">
      {onConfettie && (
        <Confettie width={innerWidth - 20} height={innerHeight} />
      )}
      <div className="w-full">
        <div className="mx-auto px-4 sm:px-6 lg:py-24 lg:px-8 w-full">
          <h2 className="text-3xl font-extrabold tracking-tight text-white text-center sm:text-4xl dark:text-white">
            Your Result
          </h2>
          <div className="flex justify-around items-center w-full flex-col gap-3 mt-4">
            ...
            <div className="button flex my-4 md:my-0 items-center gap-3">
              <Link href={"/review"}>
